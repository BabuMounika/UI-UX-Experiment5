...
Write 1–2 clear UX problem statements using a defined template: "[User] needs a way to [achieve goal] because [obstacle], which results in [impact]."
...
[Uiux-5.pdf](https://github.com/user-attachments/files/23441069/Uiux-5.pdf)
